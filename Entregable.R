...
for (a in alphas) {
  ...
  cat(paste0(
    ...
    " | Media taza disponibilidad grupo Basica: ", round(prueba3$media1, 4), "\n",
    " | Media taza disponibilidad grupo Superior: ", round(prueba3$media2, 4), "\n",
    " | Varianza grupo Basica: ", round(prueba3$var1, 6), "\n",
    " | Varianza grupo Superior: ", round(prueba3$var2, 6), "\n",
    "Cantidad grupo Basica:        ", round(prueba3$n1, 4), "\n",
    "Cantidad grupo Superior:          ", round(prueba3$n2, 4), "\n",
    "Estadístico t: ", round(prueba3$estadistico_t, 4), 
    " | Valor Crítico (±): ", round(valor_critico, 4), "\n",
    "Error: ", round(prueba3$error, 2),
